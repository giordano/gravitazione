\documentclass[a4paper,oneside,fleqn,12pt]{book}
...
{\Huge Gravitazione\\ e \\[0.3\baselineskip]
  Cosmologia} \\
(versione di Matteo Leo)\\[0.2\baselineskip]
...
\newpage
Si fa presente che il lavoro è \emph{in progress} per cui sono gradite
segnalazioni di errori ed in generale di commenti che migliorino il testo.
