...
\hypersetup{
  ...
  urlcolor=black,linkcolor=black,citecolor=black,% tutti i colori neri
}
...
% vedi
% http://www.guitex.org/home/it/forum/5-tex-e-latex/42178-comando-derivate#42199
\makeatletter
...
\newcommand\dyne{dyn} % dyne
\newcommand\erg{erg} % erg
\newcommand\parsec{pc} % parsec
\newcommand\lightyear{ly} % anno luce
\newcommand\solarmass{\ensuremath{M_{\odot}}} % massa solare
