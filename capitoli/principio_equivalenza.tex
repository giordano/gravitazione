...
effetti rilevanti su pendoli di masse gravitazionali diverse:
\begin{quotation}
...
Per rendere compatibili relatività speciale e gravitazione, Einstein suggerì
inoltre che la gravità non dovesse essere più considerata come una forza, nel
significato classico del termine, ma come una manifestazione della curvatura
dello spazio-tempo prodotta dalla presenza di materia.
...
equazione deriva dall'approssimazione di campo debole delle equazioni di
Einstein che vedremo nei prossimi capitoli e può anche essere scritta come
\begin{equation}
