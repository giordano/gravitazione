...
gravitazionale.  Per convenzione decidiamo che le operazioni di innalzamento e
abbassamento degli indici di $h_{\mu\nu}$ vengano eseguite con il tensore
metrico non perturbato $\eta_{\mu\nu}$.  La correzione al primo ordine negli
infinitesimi per il tensore metrico controvariante è data da (vedi
