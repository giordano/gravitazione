...
tuttavia, come vedremo nel paragrafo~\ref{sec:connessione-affine}, non si
trasformano, in generale, come un quadritensore di rango $3$.  Dalla definizione
di connessione affine abbiamo inoltre che questa è simmetrica rispetto agli
indici inferiori, cioè
...
\end{equation}
otteniamo la seguente relazione fra il tensore metrico e la connessione
affine\footnote{Presentiamo un utile metodo per ricordare la relazione fra
  ...
  fatta rispetto all'indice libero, nelle derivate con il segno $+$ il tensore
  ...
  rispetto all'altro indice inferiore della connessione affine.}
\begin{equation}
