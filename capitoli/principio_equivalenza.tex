...
\end{equation}
in cui $\phi$ è il potenziale newtoniano del campo gravitazionale.  Nel caso di
un campo gravitazionale prodotto da un corpo sferico di massa $M$ e raggio $R$,
l'espressione del potenziale a distanza $r > R$ è $\phi = -GM/r$.  Confrontando
le due equazioni precedenti troviamo
\begin{equation}
