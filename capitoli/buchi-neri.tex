...
è data da\index{metrica!di Kerr}
\begin{equation}
...
La metrica di Kerr-Newman, che descrive l'esterno di un buco nero sferico,
rotante ed elettricamente carico, è data da\index{metrica!di Kerr-Newman}
\begin{equation}
