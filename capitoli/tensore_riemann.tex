...
cioè se
\begin{equation}
  \int \tensor{\Gamma}{^{\alpha}_{\beta \mu}} B_{\alpha} \dd x^{\mu} =0.
\end{equation}
...
Abbiamo quindi provato che imporre la condizione~\eqref{4.3} è equivalente a
richiedere che sia valida la condizione~\eqref{4.8}.  Possiamo quindi asserire
...
\begin{equation}
  A^{\alpha} \tensor{R}{^{\alpha}_{\beta \mu \nu}} =0.
\end{equation}
