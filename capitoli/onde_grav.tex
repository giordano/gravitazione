...
\begin{equation}
  \frac{1}{45c^{5}}\dddot{D}_{ij}\dddot{D}^{ij}.
\end{equation}
...
% TODO: sistemare le ultime considerazioni, dopo di che il paragrafo dovrebbe
% essere completo.
...
esaurirsi in un tempo $\Delta t = E/I$ dell'ordine dell'anno, cioè dopo questo
periodo di tempo la stella dovrebbe smettere di ruotare.
