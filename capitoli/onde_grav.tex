...
$R_{\mu\nu} = \dalamb h/2$, quindi l'equazione di Einstein in presenza della
materia~\eqref{eq:einstein} diventa
% TODO: introdurre nel paragrafo sulle onde gravitazionali nel vuoto il tensore
% \tau_{\mu\nu} e spiegare che contiene termini del secondo ordine in R_{\mu\nu}
% - \frac{1}{2} \delta^{\mu\nu}R.
\begin{equation}
...
$\tensor{\psi}{^{\mu}_{\nu}} = \tensor{h}{^{\mu}_{\nu}}$.  La gauge
armonica~\eqref{eq:gauge-armonica} può essere definita rispetto a
$\tensor{\psi}{^{\mu}_{\nu}}$ come
\begin{equation}
...
% TODO: introdurre il tensore t_{\alpha\beta}
\begin{equation}
