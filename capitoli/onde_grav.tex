...
\begin{subequations}
  ...
  \end{align}
\end{subequations}
avendo posto $\tilde{\epsilon}_{1} = -\uimm e_{13}/k$,
...
\end{equation}
Nella gauge TT tutte le componenti $h_{\mu 0} = h_{0\mu}$ sono nulle, allora
...
particolare con $\dddot{Q}_{ij} \neq 0$.  Osserviamo che l'energia emessa dal
sistema è proporzionale $G/c^{5}$, che è un fattore estremamente piccolo, quindi
l'efficienza di emissione di radiazione da parte di masse in movimento è,
