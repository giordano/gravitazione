...
$h_{\mu\nu}$.  La~\eqref{eq:einstein-esatta} può essere interpretata come
un'equazione d'onda in $h_{\mu\nu}$ in cui il termine di sorgente
...
Einstein in presenza della materia~\eqref{eq:einstein-esatta} diventa
\begin{equation}
  \label{eq:einstein-lineare-materia1}
  \dalamb \bigg(\tensor{h}{^{\mu}_{\nu}} - \frac{1}{2}
  \tensor{\eta}{^{\mu}_{\nu}}h \bigg) =\dalamb \bigg(\tensor{h}{^{\mu}_{\nu}}
  - \frac{1}{2} \tensor{\delta}{^{\mu}_{\nu}}h \bigg) = -\frac{16\pi G}{c^{4}}
  \tensor{\tau}{^{\mu}_{\nu}}.
\end{equation}
