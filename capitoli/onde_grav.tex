...
$M \approx \SI{2e30}{\gram}$, $R \approx
\SI{8e13}{\centi\metre}$. (\textcite[272]{weinberg:gravitation})
\begin{equation}
...
dimensione di $R \sim \SI{10}{\kilo\metre}$ e ruota con pulsazione
$\omega \sim \SI[per-mode=reciprocal]{e4}{\per\second}$.  L'energia emessa per
unità di tempo sotto forma di onde gravitazionali è
(\textcite[488]{shapiro:black-holes}, \textcite[272]{weinberg:gravitation})
\begin{equation}
  I = \frac{32}{5} \frac{G}{c^{5}} \mathcal{I}^{2} \omega^{6} e^{2} \sim
  \SI{e47}{\erg\per\second}
\end{equation}
con $\mathcal{I} = \text{momento di inerzia} \sim MR^{2}$ momento d'inerzia del
corpo.  L'Energia rotazionale alla formazione della pulsar è
\begin{equation}
  E = \frac{1}{2} \mathcal{I} \omega^{2} \sim \SI{e53}{\erg}.
\end{equation}
Se la formula per l'energia emessa per unità di tempo rimane sempre valida (in
particolare non varia) allora l'energia rotazionale dovrebbe esaurirsi in un
tempo $\Delta t = \frac{E}{I}$ dell'ordine dell'anno, cioè dopo questo periodo
di tempo la stella dovrebbe smettere di ruotare e arrestarsi.
