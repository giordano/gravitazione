...
gravitazionale.\footnote{In realtà si dimostra che $t_{\mu\nu}$ si comporta come
  uno pseudotensore.  Vedi~\textcite[367-374]{landau:campo}.}
...
per $r^{2}\dd\Omega$ e integrare su tutto l'angolo solido.  Si può far vedere
che in questo modo si ottiene il seguente risultato
\begin{equation}
