...
velocità nel paragrafo~\ref{sec:fluido-perfetto} per un fluido perfetto
\begin{subequations}
  \begin{align}
  ...
  \end{align}
\end{subequations}
in cui qui con $\rho$ indichiamo è la densità di massa a riposo (e quindi
$\rho c^{2}$ è la densità di energia a riposo) e $u_{\mu}$ la quadrivelocità.
Per l'ipotesi di velocità non relativistiche si devono trascurare le componenti
spaziali della quadrivelocità rispetto alla componente temporale, cioè
$u_{i} = 0$, e quindi $T_{ij} = 0$ da cui abbiamo inoltre
\begin{equation}
...
un corpo perturbante come un nuovo pianeta, più interno di Mercurio, o un
