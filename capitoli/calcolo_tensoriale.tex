...
per una coordinata $x^{\lambda}$ produce un tensore di rango $k+1$.  All'interno
della teoria della relatività generale la situazione è differente: la
derivazione ordinaria di un tensore di rango $k$ per una coordinata
