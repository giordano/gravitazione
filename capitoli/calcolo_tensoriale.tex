...
\end{equation}
% TODO: mettere la dimostrazione se riesco a farla o capirla
...
\subsection{Differenziale covariante e trasporto parallelo}
...
$\cdd V'^{\mu} = \dd x'^{\mu} - \delta V'^{\mu}$, ma poiché questo sistema di
...
% TODO: parlare, nei paragrafi precedenti, del principio di generale covarianza
% per spiegare come scrivere rapidamente le equazioni della relatività
% generale.  Qui fare l'esempio dell'equazione della geodetica.
