...
\begin{equation}
  T^{i0} = -\parder{q}{x^{i}} \parder{\Lambda}{q_{,i}}
\end{equation}
...
Inoltre $T^{i0}$ è la densità della componente $i$ del momento.  Si possono dare
...
$T^{0i}$ è la densità di flusso di energia nella direzione $x^{i}$, $T^{ij}$ è
...
\begin{equation}
  \begin{tikzpicture}[pmatrix]
    ...
    \begin{scope}[font=\small]
      \draw[color=cyan] (t-1-3.north) -- ++(0,20pt)
      ...
      \draw[color=cyan] (t-4-3.south) -- ++(0,-25pt)
