...
\begin{equation}
  ...
  \parder{\Lambda}{x_{i}} = \parder{\Pi^{i}}{t} = c\partial^{0}\Pi^{i}.
\end{equation}
...
\begin{equation}
  ...
  (\partial^{i}\partial^{0}q)^{-1} \parder{\Lambda}{x_{i}}.
\end{equation}
Dunque abbiamo
\begin{equation}
  \partial^{0}T^{0i} =
  (\partial^{0}\partial^{i}q)(\partial^{i}\partial^{0}q)^{-1} \parder{\Lambda}{x_{i}}
  = \parder{\Lambda}{x_{i}}.
\end{equation}
Confrontando questa equazione con l'equazione~\eqref{eq:hamilton-momento}
troviamo che
\begin{equation}
  \frac{1}{c} T^{0i} = \parder{q}{x_{i}} \parder{\Lambda}{q_{,0}}
\end{equation}
