...
% % Se decidi di scrivere queste sezioni vedi la lezione del 29/03/2012 e
% % ricordati di definire il tempo proprio nel paragrafo sulla dilatazione degli
...
%%% Rappresentazione matriciale del tensore energia impulso simile a
%%% <https://it.wikipedia.org/wiki/File:StressEnergyTensor_it.svg>.  TODO:
%%% decidere se inserire questa figura, in caso affermativo completarla e
%%% integrarla nel testo
% \begin{tikzpicture}
%   \matrix [matrix of math nodes,left delimiter=(,right delimiter=)] (T)
%   {
...
%   \draw[color=cyan,fill=purple,opacity=0.4]
%   ($(T-2-2.north west)!.4!(T-2-2.center)$) --
%   ($(T-4-2.south west)!.4!(T-4-2.center)$) --
%   ($(T-4-4.south east)!.4!(T-4-4.center)$) --
%   ($(T-2-4.north east)!.4!(T-2-4.center)$) -- cycle;

%   \draw[fill,color=green,opacity=0.4]
%   ($(T-2-2.north west)!.4!(T-2-2.center)$) --
%   ($(T-2-2.south west)!.4!(T-2-2.center)$) --
%   ($(T-4-4.south west)!.4!(T-4-4.center)$) --
%   ($(T-4-4.south east)!.4!(T-4-4.center)$) --
%   ($(T-4-4.north east)!.4!(T-4-4.center)$) --
%   ($(T-2-2.north east)!.4!(T-2-2.center)$) -- cycle;

%   \draw[color=cyan,fill=gray,opacity=0.4]
%   ($(T-1-1.north west)!.4!(T-1-1.center)$) --
%   ($(T-1-1.south west)!.4!(T-1-1.center)$) --
%   ($(T-1-1.south east)!.4!(T-1-1.center)$) --
%   ($(T-1-1.north east)!.4!(T-1-1.center)$) -- cycle;

%   \draw[color=cyan,fill=gray,opacity=0.4]
%   ($(T-2-1.north west)!.4!(T-2-1.center)$) --
%   ($(T-4-1.south west)!.4!(T-4-1.center)$) --
%   ($(T-4-1.south east)!.4!(T-4-1.center)$) --
%   ($(T-2-1.north east)!.4!(T-2-1.center)$) -- cycle;
...
%   \draw[color=cyan,fill=gray,opacity=0.4]
%   ($(T-1-2.north west)!.4!(T-1-2.center)$) --
%   ($(T-1-2.south west)!.4!(T-1-2.center)$) --
%   ($(T-1-4.south east)!.4!(T-1-4.center)$) --
%   ($(T-1-4.north east)!.4!(T-1-4.center)$) -- cycle;
% \end{tikzpicture}
