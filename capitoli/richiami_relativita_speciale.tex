...
\emph{Nota: in questo paragrafo esplicitiamo la velocità della luce nel vuoto e
  adottiamo il sistema di unità di Gauss.}
...
$a \ll cT = \lambda$.  Poiché ci troviamo a grandi distanze dalla sorgente e
poiché $a \ll \lambda$, le onde emesse dal sistema possono essere considerate,
in piccole regioni dello spazio, come onde piane.  Il potenziale vettore
$\bm{A}$ può anche essere scritto come
\begin{equation}
...
\begin{equation}
  \bm{A} = \frac{1}{rc} \int (\rho\bm{v})|_{t-r/c} \dd V = \frac{1}{rc} \sum_{i}
  q_{i}\bm{v}_{i} = \frac{1}{rc} \dot{\bm{d}},
\end{equation}
...
\end{equation}
momento di dipolo totale del sistema, sempre calcolato al tempo $t-r/c$.
...
nell'approssimazione di dipolo appena sviluppata ed è nulla se il momento di
dipolo è nullo (o almeno se $\ddot{\bm{d}} = \bm{0}$).
