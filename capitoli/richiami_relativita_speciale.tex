...
\begin{equation}
  p^{\alpha} = (E, \bm{p}).
\end{equation}
% TODO: fermo a questo punto, devo completare i calcoli relativi alla
% trasformazione del quadrimpulso.  Però sono bloccato perché non mi tornano i
% conti, devo ricontrollarli!
