...
del quadrimomento.  Invece
\begin{equation}
  \frac{1}{c} T^{0i} = \parder{q}{x_{i}} \parder{\Lambda}{q_{,0}}
\end{equation}
è la densità della componente $i$ del momento tridimensionale,
% equivalentemente la densità del flusso di energia
% (vedi~\textcite[112-113]{landau:campi}, per un approfondimento).
pertanto
\begin{equation}
...
\begin{itemize}
\item $T^{00} =$ densità di energia;
\item $T^{0i}/c =$ densità della componente $j$ del momento;
\item $cT^{i0} =$ densità del flusso di energia che attraversa l'unità di
  superficie nell'unità di tempo nella direzione $x^{i}$;
\item $T^{ij} =$ densità del flusso della componente $j$ del momento nella
  ...
  superficie perpendicolare all'asse $j$.
\end{itemize}
